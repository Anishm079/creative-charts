...
const Chart: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const hierarchy = d3.hierarchy<DataNode>(data)
      .sum((d: any) => d.value)
      .sort((a, b) => b.height - a.height || b.value - a.value);

    const root = d3.partition<DataNode>()
    ...
    const rect = cell.append("rect")
      ...
      .on("click", (event: any, p: any) => clicked(event, p, root, svg, cell, rect, text, tspan));
    ...
    let focus = root;
    function clicked(event: any, p: any, root: any, svg: any, cell: any, rect: any, text: any, tspan: any) {
  ...
  return <div style={{width:"100%",height:"100%"}}>
        <h2>Icelandic population by age</h2>
