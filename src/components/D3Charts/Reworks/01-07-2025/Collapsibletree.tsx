...
const Chart: React.FC = () => {
  ...
  useEffect(() => {
    ...
    svgElement
      ...
      .attr(
        "style",
        "width: 100%; height: auto; font: 10px sans-serif; user-select: none;"
      );

    const gLink = svgElement
      .append("g")
      .attr("fill", "none")
      .attr("stroke", "#555")
  ...
  return <>
    <h2 style={{color:"black"}} >Collapsible Tree</h2>
    <svg ref={svgRef}></svg>;
  </> 
};
