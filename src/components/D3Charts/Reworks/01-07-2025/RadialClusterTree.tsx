...
const RadialClusterChart: React.FC = () => {
  ...
  return <>
    <h2 style={{color:"#000", margin:0,padding:0,position:"absolute",width:"100%"}} >Radial Cluster Chart</h2>
    <svg ref={ref}></svg>;
  </>
};
