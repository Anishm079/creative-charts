...
const parseDomain = () => [
  ...
  Math.max(
    Math.max.apply(
      null,
      location1.map((entry) => entry.value)
    ),
    Math.max.apply(
      null,
      location2.map((entry) => entry.value)
    )
  ),
];
...
export default class HourlyTrafficVolumeOrCrowdDensityDataForTwoDifferentLocations extends PureComponent {
    ...
    return (
      <div style={{ width: "80%" }}>
        <h2 style={{ color: "black", width: "100%" }}>
          hourly traffic volume or crowd density data for two different
          locations
        </h2>
        <ResponsiveContainer width="100%" height={60}>
          <ScatterChart margin={{ top: 10, right: 0, bottom: 0, left: 0 }}>
            ...
            />
            <Scatter data={location1} fill="#8884d8" />
          </ScatterChart>
        </ResponsiveContainer>
        <ResponsiveContainer width="100%" height={60}>
          <ScatterChart
          ...
          >
            ...
            <Tooltip
              ...
              content={this.renderTooltip}
            />
            <Scatter data={location2} fill="#8884d8" />
          </ScatterChart>
        </ResponsiveContainer>
        <ResponsiveContainer width="100%" height={60}>
          <ScatterChart
