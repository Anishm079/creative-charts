...
interface iData{ city: string, lat: number, lon: number, population: number }
...
function getData():iData[] {
  ...
  const ChartComponent: React.FC = () => {
    ...
    return <div id="myChart" style={{ width: "90dvw", height: "90dvh", background:"linear-gradient(to right,#6a82fb, #ffb347)" }}></div>;
  };
