...
const chromosomes_arr = [...Array(23).keys()].map(x => x + 1); // Example data for chromosomes
...
const ChartComponent: React.FC = () => {
  ...
  return <div id="myChart" style={{ height: '90dvh', width: '90dvw' }}></div>;
};
const chromosomes = [
    "1",
    "2",
